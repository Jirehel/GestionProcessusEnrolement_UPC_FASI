<?php
$idd=0; 
    include './controllers/all_sessions_controlleur.php';
        ...
        <div class="container-fluid">
            ...
            <div class="row clearfix">
                ...
                <div class="list-group">
                    <?php foreach ($badg_c->liste_sessions() as $entry) { ?>
                    <a href="<?="index.php?p=all-listes-enrollement&sessionid=".$entry[0]  ?>" data-placement="bottom" title="<?=$entry[4]==1?"Encours":"Cloturée" ?>" class="list-group-item list-group-item-action"><?="Periode: ".$entry[1]."  ".$entry[2]." " ?></a>
                    <?php }?>
                </div>
                </div>
            </div>
